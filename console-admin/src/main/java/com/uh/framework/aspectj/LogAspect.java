...
import com.uh.common.enums.BusinessStatus;
import com.uh.common.enums.HttpMethod;
...
public class LogAspect
{
    ...
    private void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            // 保存数据库
            operLog.setOperLocation(AddressUtils.getRealAddressByIP(operLog.getOperIp(), consoleConf.isAddressEnabled()));
     ...
     * @throws Exception
     */
    private void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) throws Exception
    {
        // 设置action动作
     ...
     * 忽略敏感属性
     */
    private PropertyPreFilter excludePropertyPreFilter()
    {
